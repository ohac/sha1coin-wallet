...
import com.google.sha1coin.core.Transaction.Purpose;
...
import com.google.sha1coin.wallet.DefaultCoinSelector;
...
public class TransactionsListAdapter extends BaseAdapter
{
	...
	public void bindView(@Nonnull final View row, @Nonnull final Transaction tx)
	{
		...
		rowValue.setAmount(BigInteger.valueOf(value.longValue()));
