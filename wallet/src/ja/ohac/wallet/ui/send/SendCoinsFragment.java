...
import ja.ohac.wallet.ExchangeRatesProvider;
import ja.ohac.wallet.ExchangeRatesProvider.ExchangeRate;
import ja.ohac.wallet.WalletApplication;
import ja.ohac.wallet.data.PaymentIntent;
import ja.ohac.wallet.data.PaymentIntent.Standard;
import ja.ohac.wallet.integration.android.BitcoinIntegration;
import ja.ohac.wallet.offline.DirectPaymentTask;
import ja.ohac.wallet.ui.AbstractBindServiceActivity;
import ja.ohac.wallet.ui.AddressAndLabel;
import ja.ohac.wallet.ui.CurrencyAmountView;
import ja.ohac.wallet.ui.CurrencyCalculatorLink;
import ja.ohac.wallet.ui.DialogBuilder;
import ja.ohac.wallet.ui.EditAddressBookEntryFragment;
import ja.ohac.wallet.ui.ExchangeRateLoader;
import ja.ohac.wallet.ui.InputParser.BinaryInputParser;
import ja.ohac.wallet.ui.InputParser.StreamInputParser;
import ja.ohac.wallet.ui.InputParser.StringInputParser;
import ja.ohac.wallet.ui.ProgressDialogFragment;
import ja.ohac.wallet.ui.ScanActivity;
...
public final class SendCoinsFragment extends SherlockFragment
{
				...
				if (pending.signum() > 0)
					msg.append(
							getString(R.string.send_coins_fragment_pending,
									btcPrefix + ' ' + GenericUtils.formatValue(BigInteger.valueOf(pending.longValue()), btcPrecision, btcShift))).append("\n\n");
	...
	{
		final BigInteger available = BigInteger.valueOf(wallet.getBalance(BalanceType.AVAILABLE).longValue());
