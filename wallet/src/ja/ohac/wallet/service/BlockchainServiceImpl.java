...
package ja.ohac.wallet.service;
...
import com.google.sha1coin.core.BlockChain;
import com.google.sha1coin.core.CheckpointManager;
import com.google.sha1coin.core.Coin;
import com.google.sha1coin.core.Peer;
import com.google.sha1coin.core.PeerEventListener;
...
import ja.ohac.wallet.WalletBalanceWidgetProvider;
			...
			handler.post(new Runnable()
			{
				...
				public void run()
				{
					...
					if (isReceived && !isReplayedTx)
						notifyCoinsReceived(from, BigInteger.valueOf(amount.longValue()));
				}
			});
		}
